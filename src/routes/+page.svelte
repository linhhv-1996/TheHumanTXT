...
{#if !travelMode}
    ...
    <div id="footer-links" transition:fade={{ duration: 300 }}>
        ...
        <a class="footer-link" target="_blank" rel="noopener noreferrer" href="https://basescan.org/address/0x2DC682a88f4aa9339720d58AFE41A8fd0a785997#events">Verify on-chain ↗</a>
    </div>
{/if}
